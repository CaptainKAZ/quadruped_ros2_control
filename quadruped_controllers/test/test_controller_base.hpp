...
#ifndef TEST_QUADRUPED_CONTROLLERS_HPP_
#define TEST_QUADRUPED_CONTROLLERS_HPP_
...
class TestableQuadrupedControllerBase : public quadruped_controllers::QuadrupedControllerBase
{
  FRIEND_TEST(QuadrupedControllerBaseTest, joint_names_parameter_not_set);
  FRIEND_TEST(QuadrupedControllerBaseTest, interface_parameter_not_set);
  FRIEND_TEST(QuadrupedControllerBaseTest, all_parameters_set_configure_success);

public:
  CallbackReturn on_configure(const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = quadruped_controllers::QuadrupedControllerBase::on_configure(previous_state);
...
class QuadrupedControllerBaseTest : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    controller_ = std::make_unique<TestableQuadrupedControllerBase>();

    command_publisher_node_ = std::make_shared<rclcpp::Node>("command_publisher");
    command_publisher_ = command_publisher_node_->create_publisher<ControllerCommandMsg>(
      "/test_quadruped_controllers/commands", rclcpp::SystemDefaultsQoS());
  }
...
protected:
  ...
  {
    const auto result = controller_->init("test_quadruped_controllers");
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_quadruped_controllers/state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestableQuadrupedControllerBase> controller_;
...
class QuadrupedControllerBaseTestParameterizedParameters
: public QuadrupedControllerBaseTest,
  public ::testing::WithParamInterface<std::tuple<std::string, rclcpp::ParameterValue>>
{
public:
  virtual void SetUp() { QuadrupedControllerBaseTest::SetUp(); }

  static void TearDownTestCase() { QuadrupedControllerBaseTest::TearDownTestCase(); }

protected:
  void SetUpController(bool set_parameters = true)
  {
    QuadrupedControllerBaseTest::SetUpController(set_parameters);
...
#endif  // TEST_QUADRUPED_CONTROLLERS_HPP_
