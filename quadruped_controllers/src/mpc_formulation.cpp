...
void MpcFormulation::buildStateSpace(double mass, const Matrix3d& inertia, const QuadrupedState& state)
{
...
const VectorXd& MpcFormulation::buildGVec(double gravity, const QuadrupedState& state,
